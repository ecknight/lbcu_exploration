...
#12. Save----
write.csv(dat.final, "Data/LBCU_FilteredData_Segmented.csv", row.names = FALSE)
write.csv(dat.final, "/Users/ellyknight/Dropbox/LBCU/LBCU_FilteredData_Segmented.csv", row.names = FALSE)
write.csv(dat.final, "/Users/ellyknight/Documents/SMBC/Analysis/lbcu_mc/Data/LBCU_FilteredData_Segmented.csv", row.names = FALSE)
